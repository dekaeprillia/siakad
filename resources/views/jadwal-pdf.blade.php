    ...
    <div class="container">
        <div class="row mt-5">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tfoot>
                    <tr>
                        <th colspan="5" class="text-center"><strong>Copyright &copy; <script>document.write(new Date().getFullYear());</script> :: <a href="">Pon-Pes Modern Daarul Falah Carenang</a>. </strong></th>
                    </tr>
                </tfoot>
            </table>
        </div>
